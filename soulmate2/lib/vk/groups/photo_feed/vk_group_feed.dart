...
import 'package:soulmate2/vk/groups/photo_feed/vk_group_photos_feed_bloc.dart';
import 'package:soulmate2/vk/groups/photo_feed/vk_group_photos_repository.dart';
              ...
              child: CustomScrollView(slivers: [
                ...
                SliverList(
                  delegate: SliverChildBuilderDelegate(
                      (context, index) => ImageListItem(index: index, list: state.images.list),
